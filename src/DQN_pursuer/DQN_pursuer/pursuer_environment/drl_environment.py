...
class DRLEnvironment(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        # clients
        self.task_succeed_client = self.create_client(RingGoal, 'task_succeed_p')
        self.task_fail_client = self.create_client(RingGoal, 'task_fail_p')
        # servers
        self.step_comm_server = self.create_service(DrlStep, 'step_comm_p', self.step_comm_callback)
        self.goal_comm_server = self.create_service(Goal, 'goal_comm_p', self.goal_comm_callback)

...
from DQN_pursuer.pursuer_environment.reward import SUCCESS
...
class Graph():
    def __init__(self):
        ...
        titles = ['DQN Pursuer', 'avg critic loss over episode', 'avg actor loss over episode', 'avg reward over 10 episodes']
        for i in range(4):

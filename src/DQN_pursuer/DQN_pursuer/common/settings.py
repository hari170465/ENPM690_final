...
ENABLE_MOVING_GOALS      = False    # If true, goals are moving and the robot has to follow them
ENABLE_GENERATE_GOALS    = False    # If true, goals are generated randomly
...
TOPIC_SCAN = '/tb0_0/scan'
TOPIC_VELO = '/tb0_0/cmd_vel'
TOPIC_ODOM = '/tb0_0/odom'
...
REAL_TOPIC_SCAN  = '/tb0_0/scan'
REAL_TOPIC_VELO  = '/tb0_0/cmd_vel'
REAL_TOPIC_ODOM  = '/tb0_0/odom'

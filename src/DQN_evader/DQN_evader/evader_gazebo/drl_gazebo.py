...
from ..evader_environment.drl_environment import ARENA_LENGTH, ARENA_WIDTH, ENABLE_DYNAMIC_GOALS
...
class DRLGazebo(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        self.entity_dir_path = (os.path.dirname(os.path.realpath(__file__))).replace(
            'DQN_evader/lib/python3.8/site-packages/DQN_evader/evader_gazebo',
        ...
        ************************************************************"""
        ...
        # self.new_goal_pose_pub = self.create_publisher(Pose, 'new_goal_pose', QoSProfile(depth=10))
    ...
    *******************************************************************************"""
    ...
    #     # Publish the new goal pose to the new topic
    #     self.new_goal_pose_pub.publish(new_goal_pose)
    #     print(f"Published new goal to 'new_goal_pose': ({new_goal_pose.position.x}, {new_goal_pose.position.y})")

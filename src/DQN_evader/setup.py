...
setup(
    ...
    entry_points={
        'console_scripts': [
            'environment = DQN_evader.evader_environment.drl_environment:main',
            'real_environment = DQN_evader.evader_environment.drl_environment_real:main',
            'gazebo_goals = DQN_evader.evader_gazebo.drl_gazebo:main',
            'train_agent = DQN_evader.evader_agent.drl_agent:main_train',
            'test_agent = DQN_evader.evader_agent.drl_agent:main_test',
            'real_agent = DQN_evader.evader_agent.drl_agent:main_real',
        ],
    },
)
